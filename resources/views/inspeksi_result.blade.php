                ...
                <tr>
                    ...
                    <th class="px-3 text-sm font-bold uppercase border-b md:py-2 bg-grey-lightest text-grey-dark border-grey-light">
                        @if (Auth::user()->role == 'admin')
                            Edit Akses
                        @endif
                        @if (Auth::user()->role == 'safety' || Auth::user()->role == 'mekanik' || Auth::user()->role == 'supervisor')
                            Form Inspeksi
                        @endif
                    </th>
                    @endif
            ...
            <tbody>
                ...
                <tr class="hover:bg-grey-lighter">
                    ...
                    <td class="border-b md:py-2 border-grey-light">
                        ...
                        Belum Diinspeksi
                        @else
                        {{\Carbon\Carbon::parse($p->periode)->format('d-m-Y') }} - {{ \Carbon\Carbon::parse($p->periode_akhir)->format('d-m-Y') }}
                        @endif
                    </td>
                    <td class="border-b md:py-2 border-grey-light">
                        @if ($p->keterangan == '0')
